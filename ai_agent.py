...
class MarketingAnalyticsAgent:
    ...
    def process_question(self, question: str) -> str:
        ...
        # Используем RAG только в определенных случаях и если RAG система доступна:
        # 1. Нет данных для анализа ИЛИ
        # 2. Пользователь явно спрашивает о терминах/метриках
        should_use_rag = (not has_data or is_asking_about_terms) and self.rag_system is not None
        ...
        if should_use_rag:
            try:
                ...
                # Если RAG система недоступна, продолжаем без неё
                print(f"RAG система недоступна: {e}")
                pass
